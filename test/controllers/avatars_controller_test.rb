...
class AvatarsControllerTest < ActionController::TestCase
  ...
  test "should create avatar" do
    assert_difference('Avatar.count') do
      post :create, avatar: { generated: @avatar.generated, image_location: @avatar.image_location, user_id: @avatar.user_id }
    end
  ...
  test "should update avatar" do
    patch :update, id: @avatar, avatar: { generated: @avatar.generated, image_location: @avatar.image_location, user_id: @avatar.user_id }
    assert_redirected_to avatar_path(assigns(:avatar))
  end
